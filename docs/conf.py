#!/usr/bin/env python
#
# dojo_ds documentation build configuration file, created by
...
version = dojo_ds.__version__
# The full version, including alpha/beta/rc tags.
release = dojo_ds.__version__
...
def run_apidoc(_):
	...
	module = os.path.join(cur_dir,"..","dojo_ds")
